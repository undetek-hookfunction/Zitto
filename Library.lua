...
do -- Library
	Library = {
		Open = true;
		Accent = Color3.fromRGB(158, 255, 166);
		Pages = {};
		Sections = {};
		Flags = {};
		UnNamedFlags = 0;
    ...
    do 
        ...
        if not isfolder(UICache) then 
            makefolder(UICache)
        end

        --
        writefile(AssetsDir.."/MainFont.ttf", game:HttpGet("https://github.com/undetek-hookfunction/Zitto/raw/refs/heads/main/ProggyTiny.ttf"))
        -- 
            ...
            faces = {
                {
                    ...
                    weight = 400,
                    style = "normal",
                    assetId = getcustomasset(AssetsDir.."/MainFont.ttf")
                }
            }
        }
	...
	do
		...
		function Library:Window(Options)
			...
			local ZittoWin = Instance.new("ScreenGui", Path)
			...
			ScriptTitle.Text = 'Zitto.<font color="rgb(158, 255, 166)">win</font> | Beta'
